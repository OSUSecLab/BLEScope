...
public class TaintRules {
	...
	public static void main(String[] args) {
		System.out.println(TaintRules.getInstance().isBaseIntrested("<java.lang.String: java.lang.String trim()>"));
		System.out.println(TaintRules.getInstance().getInterestedArgIndexes("<android.content.Context: java.lang.String getStringss(int,int,int)>", 3));
	}
